package com.david.gotmuzei.utils;
...
public class Constants {
    ...
    public static final String IMAGE_CREATOR = "Nickorama144";
    public static final String APP_CREATOR = "David Hodge";

    public static final String APP_CREATOR_LINK = "";
    public static final String IMAGE_CREATOR_LINK = " ";
    ...
    public static final String APP_RATE_URL = "https://play.google.com/store/apps/details?id=com.david.gotmuzei";
}
